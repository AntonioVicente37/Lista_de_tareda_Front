...
//Capurando os dados da edição e salvando no banco de dados
document.querySelector("#btn_atualizar").addEventListener('click', () => {
    ...
    if(task_text.length > 100){
        error.textContent = "O texto deve ser menos de 100 caracteres.";
        error.classList.remove("d-none");
        return;
    }
    ...
    window.location.href = window.location.origin + "C:/laragon/www/frontend/index.html";
})